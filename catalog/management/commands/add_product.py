...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        #
        # products = [
        #     {'name': 'raspberry', 'description': 'test', 'category': category3, 'price': '350'},
        #     {'name': 'carrot', 'description': 'test', 'category': category1, 'price': '55'},
        #     {'name': 'pear', 'description': 'test', 'category': category2, 'price': '239'},
        #     {'name': 'strawberry', 'description': 'test', 'category': category3, 'price': '299'},
        # ]
        #
